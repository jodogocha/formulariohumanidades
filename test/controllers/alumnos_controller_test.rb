...
class AlumnosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alumno" do
    assert_difference('Alumno.count') do
      post alumnos_url, params: { alumno: { apellido: @alumno.apellido, barrio: @alumno.barrio, cedula: @alumno.cedula, ciudad: @alumno.ciudad, correo: @alumno.correo, nombre: @alumno.nombre, telefono: @alumno.telefono } }
    end
  ...
  test "should update alumno" do
    patch alumno_url(@alumno), params: { alumno: { apellido: @alumno.apellido, barrio: @alumno.barrio, cedula: @alumno.cedula, ciudad: @alumno.ciudad, correo: @alumno.correo, nombre: @alumno.nombre, telefono: @alumno.telefono } }
