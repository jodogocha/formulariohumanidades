class AlumnosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @alumno.save
        format.html { redirect_to @alumno, notice: 'Alumno creado.' }
  ...
  def update
    respond_to do |format|
      if @alumno.update(alumno_params)
        format.html { redirect_to @alumno, notice: 'Alumno actualizado.' }
  ...
  private
    ...
    def alumno_params
      params.require(:alumno).permit(:nombre, :apellido, :cedula, :telefono, :correo, :barrio, :ciudad, :tpersona_id, :carrera_id)
    end
end
